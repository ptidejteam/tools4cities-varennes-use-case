...
class EntityRemover:
    ...
    def remove_building_entity(building_entity_list, entity, entity_type=None, entity_object=None):
        """
        Removes a building_structure entity: floor, meter, weather station and schedule
        :param entity: the entity to be removed
        :param entity_type: a string representing the entity (e.g., floor) to remove
        :param building_entity_list: the building_structure whose entity is being removed
