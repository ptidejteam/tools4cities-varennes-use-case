...
class Building(Observable):
    """
    A representation of a building_structure
    ...
    def __init__(self, construction_year: int, height: AbstractMeasure, floor_area: AbstractMeasure,
        ...
        """
        :param construction_year: The construction year of the building_structure
        :param height: The height of the building_structure
        :param floor_area: The floor area of the building_structure
        :param internal_mass: The internal mass of the building_structure
        :param address: The address of the building_structure
        :param building_type: The type of building_structure
        """
        super().__init__()
        self._UID = str(uuid4())
    ...
    def add_weather_station(self, weather_station: WeatherStation):
        """
        Adds a weather station to a building_structure
    ...
    def add_meter(self, meter: Meter):
        """
        Adds a meter to a building_structure
    ...
    def add_floors(self, floors: List[Floor]):
        """
        Add multiple unique (by floor number) floors to a building_structure
        :param floors: the floors to add to this building_structure
        :return:
        """
    ...
    def remove_floor(self, floor: Floor):
        """
        Removes floor from a building_structure
    ...
    def add_room(self, floor_uid: str, name: str, area: AbstractMeasure,
                 ...
                 location: str = None):
        """
        Adds a room to a building_structure's floor
    ...
    def add_open_space(self, floor_uid: str, name: str, area: AbstractMeasure,
        ...
        """
        Adds an open space to a building_structure's floor
