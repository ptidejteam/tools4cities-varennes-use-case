...
class Address:
    """
    Address of a building_structure
    ...
    def __init__(self, city: str, street: str, state: str, zip_code: str, country: str,
        ...
        :param country: the country where the building_structure is located
        ...
        :param north_orientation: The north orientation of a building_structure.
        """
        self.city = city
        self.street = street
        self.state = state
